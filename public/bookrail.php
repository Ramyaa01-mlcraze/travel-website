					...
					<div class="outer_box">
						...
						<table>
							...
							<tr>
								<td>Return Date</td>
								<td>
									<input class="textbox-n" type="text" onmouseover="(this.type='date')"  id="date" name="Arrival" required="required" placeholder="Return Date" min="2020-10-18" max="2020-12-31"><!-- </p> -->
								</td>
							</tr>
						</table>
						</center>
