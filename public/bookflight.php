					...
					<div class="outer_box">
						...
						<table>
							<tr>
								...
								<td>
									<input class="textbox-n" type="text" onmouseover ="(this.type='date')"  id="date" name="departure" required="required" placeholder="Departure Date" min="2020-10-18" max="2021-12-31">
								</td>
							</tr>
							<tr>
								<td>Return Date</td>
								<td>
									<input class="textbox-n" type="text" onmouseover="(this.type='date')"  id="date" name="Arrival" required="required" placeholder="Return Date" min="2020-10-18" max="2021-12-31"><!-- </p> -->
								</td>
							</tr>
						</table>
						</center>
