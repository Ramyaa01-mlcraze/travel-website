...
<?php 
$connection = mysqli_connect('localhost', 'root', '','tourtravel');
if (!$connection){
	die("Database Connection Failed" . mysql_error());
}
$select_db = mysqli_select_db($connection,'tourtravel');
if (!$select_db){
	...
	<div class="top">
		<div class="top-left" >
			<ul class="top-one">
				...
				<li class="end"><a href="" >travel.partner@anywhere.com</a></li>
			</ul>
		</div>
		<div class="top-right">
			<ul class="top-two">
	...
	<div class="content" id="place" style="background-image: url('images/3.jpg');">
		<div class="content-left">
			<ul class="content-one">
				<li><a href="home.php">TRAVEL PARTNER</a></li>
			</ul>
		</div>
					...
					<div id="myModal" class="modal">
						...
						<div class="modal-content">
							...
							<div class="modal-footer">
								<h3>&copy; 2020 Travel partner | All Rights Reserved | </h3>
							</div>
						</div>
